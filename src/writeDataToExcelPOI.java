...
public class writeDataToExcelPOI {
	...
	public static void main(String... strings) throws IOException {
		...
		String[] valueToWrite = { "Sagar", "Pune" };

		// Create an object of current class

		writeDataToExcelPOI objExcelFile = new writeDataToExcelPOI();

		// Write the file using file name , sheet name and the data to be filled

		objExcelFile.writeExcel(System.getProperty("user.dir")
				+ "\\resources\\", "Sample_Excel.xlsx", "Sheet1", valueToWrite);
